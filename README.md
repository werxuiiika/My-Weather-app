...
<details open>
<summary><b>1.0.20 — «Управление городами»</b> (текущая)</summary>
...
<details>
<summary><b>1.0.19 — умный поиск</b></summary>

- Мультиязычный поиск: язык приложения → английский → транслитерация кириллицы
- Замороженные имена сохранённых городов, выровненные температуры в карточках
- Копирование координат долгим нажатием, шапка города при свайп-обновлении

</details>

<details>
<summary><b>1.0.18-fix — честное обновление</b></summary>

- Обновление по сохранённым координатам, без запроса геолокации
- Фикс плагина expo-localization в сборке

</details>

<details>
<summary><b>1.0.18 — почасовой прогноз</b></summary>

- Почасовой прогноз с восходом/закатом и индикатором «Now»
- Релизы по тэгам и кэш Gradle в CI
