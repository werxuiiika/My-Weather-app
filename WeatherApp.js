...
const buildStyles = (theme, fs) =>
  StyleSheet.create({
    ...
    title: { fontSize: fs.base * 2, fontWeight: '700', color: theme.text, textAlign: 'center', marginTop: -12 },
    ...
    gearButton: { marginRight: 0, marginTop: -14, padding: fs.spacing * 0.375, zIndex: 1 },
