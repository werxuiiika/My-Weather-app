...
const buildStyles = (theme, fs) =>
  StyleSheet.create({
    ...
    titleRow: { position: 'relative', alignItems: 'center', justifyContent: 'center', marginBottom: fs.spacing },
    ...
    settingsSafe: { flex: 1 },
    settingsHeader: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: fs.spacing, paddingTop: fs.spacing * 2.875, paddingBottom: fs.spacing * 0.75, borderBottomWidth: 1, borderBottomColor: theme.border },
    ...
    aboutCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: theme.surface, borderRadius: 16, paddingHorizontal: fs.spacing, paddingVertical: fs.spacing * 0.875, minHeight: fs.cardHeight },
    aboutCardTextWrap: { flex: 1, marginRight: fs.spacing * 0.75 },
