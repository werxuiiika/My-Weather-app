...
const buildStyles = (theme, fs) =>
  StyleSheet.create({
    ...
    container: { flex: 1, position: 'relative', paddingHorizontal: fs.spacing * 1.25, paddingTop: fs.spacing * 0.25 },
    titleRow: { position: 'relative', alignItems: 'center', justifyContent: 'center', marginBottom: fs.spacing, marginTop: (StatusBar.currentHeight || 0) + fs.spacing * 0.125 },
    gearButton: { position: 'absolute', right: 0, top: fs.spacing * 0.125, padding: fs.spacing * 0.375 },
    ...
    aboutCard: { flexDirection: 'row', alignItems: 'flex-start', backgroundColor: theme.surface, borderRadius: 16, paddingHorizontal: fs.spacing, paddingVertical: fs.spacing * 0.875, minHeight: 64 * fs.fontScale },
    aboutCardTextWrap: { flex: 1, marginRight: fs.spacing * 1.25, paddingRight: 50 * fs.fontScale, flexWrap: 'wrap' },
