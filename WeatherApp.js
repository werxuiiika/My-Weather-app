...
const buildStyles = (theme, fs) =>
  StyleSheet.create({
    ...
    title: { fontSize: fs.base * 2, fontWeight: '700', color: theme.text, textAlign: 'center', marginTop: -4 },
    ...
    gearButton: { marginRight: 8, marginTop: -4, padding: fs.spacing * 0.375, zIndex: 1 },
