...
const buildStyles = (theme, fs) =>
  StyleSheet.create({
    ...
    titleRow: { position: 'relative', alignItems: 'center', justifyContent: 'center', marginBottom: fs.spacing, marginTop: fs.spacing * 0.25 },
    gearButton: { position: 'absolute', right: 0, top: (StatusBar.currentHeight || 0) + fs.spacing * 0.25, padding: fs.spacing * 0.375 },
