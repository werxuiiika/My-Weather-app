...
const buildStyles = (theme, fs) =>
  StyleSheet.create({
    ...
    aboutCard: { flexDirection: 'row', alignItems: 'flex-start', backgroundColor: theme.surface, borderRadius: 16, paddingHorizontal: fs.spacing, paddingVertical: fs.spacing * 0.875 },
    aboutCardTextWrap: { flex: 1, marginRight: fs.spacing * 0.75, flexWrap: 'wrap' },
