...
const buildStyles = (theme, fs) =>
  StyleSheet.create({
    ...
    title: { fontSize: fs.base * 2, fontWeight: '700', color: theme.text, textAlign: 'center', marginTop: -8 },
    ...
    gearButton: { marginRight: 4, marginTop: -8, padding: fs.spacing * 0.375, zIndex: 1 },
